...
function numberOfCharacters(string) {
  ...
  for (var i = 0; i < string.length; i++) {
    if (rta[string[i]]===undefined) {rta[string[i]]=1;
    } else { rta[string[i]]=rta[string[i]]+1;
    }
  }
return rta;
}
...
//  }
//}
//for (var j = 0; j < (s.length-cantMAY); j++) {
//  rta=rta+rta[j];
//}
//rta=rta.slice(s.length-cantMAY);
//return rta;
//}
