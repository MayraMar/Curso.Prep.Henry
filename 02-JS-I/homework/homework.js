...
const nuevaString = 'soy una cadena de caracteres';
...
function tienenMismaLongitud(str1, str2) {
  ...
  // Tu código:
var rta=false
if(str1.length===str2.length){rta=true};
return rta;
}
...
function esImpar(num) {
  ...
  // De lo contrario, devuelve "false"
  // Tu código:var rta=false;
  var rta=true;
  if (num%2===0){rta=false};
  return rta;
}
...
var rta='Es positivo';
if(numero===0){rta=false};
if(numero<0){rta='Es negativo'};
return rta;
}
